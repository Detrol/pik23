...
@section('content')
    ...
    <section>
        <div class="relative items-center w-full px-5 py-24 md:py-0 mx-auto md:px-12 lg:px-16 max-w-7xl">
            <div class="w-full mx-auto text-left">
                <div class="relative flex-col items-center m-auto align-middle">
                    <div class="items-center gap-12 text-left lg:gap-24 lg:inline-flex">
                        ...
                        <div class="order-first block w-full mt-12 aspect-square lg:mt-0 lg:pt-[10rem]">
