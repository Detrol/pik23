...
@section('content')
    ...
    <section class="relative h-[12rem] md:h-[14rem]">
        <div class="jarallax relative h-[12rem] md:h-[14rem]" data-jarallax
        ...
        <div class="custom-shape-divider-bottom-16795258882 z-10 -mb-1">
            ...
            <div>
                <div class="max-w-2xl">
                    ...
                    <div class="mt-3 text-base text-gray-500">
                        <p class="mb-3">Givetvis så får du garanti när jag utför jobb hos dig även de bästa kan råka få ränder, eller
                        ...
                        <p>En annan sak som i vissa fall händer, är att fåglar, kanske av ren djävulskap, får för sig att skita
                           på era fönster direkt efter de blivit putsade. Men oroa dig inte! Detta åtgärdar jag givetvis också,
                           och i detta fallet har du 14 dagar på dig efter utfört arbete.</p>

                        <p class="fw-medium">Garantin gäller dock enbart puts som utförs inom 1 mil utifrån min utgångspunkt på Norrstrand.</p>
                    </div>
                </div>
            </div>
        </div>
