...
@section('title', 'Garanti på fönsterputsning i Karlstad | Puts i Karlstad')

@section('meta_description', 'Puts i Karlstad erbjuder garanti på fönsterputstjänster. Professionell fönsterputsning med kvalitetsgaranti och kundnöjdhet i fokus. Boka tryggt idag!')
            ...
            <div class="w-full mx-auto text-left">
                <div class="relative">
                    <div class="justify-center flex flex-col text-left min-h-[60vh]">
                        <h1 class="text-4xl font-bold text-black antialiased mb-4">
                            Garanti på fönsterputsning i Karlstad
                        </h1>
                        <h2 class="max-w-7xl mt-4 mb-10 text-xl tracking-tight text-gray-600">
                            Hos mig får du garanti vid det oväntade
                        </h2>
                        ...
                        <div class="mt-8">
                            <h3 class="text-2xl font-semibold text-black mb-4">Sammanfattning av garantin:</h3>
                            <ul class="list-disc list-inside text-gray-600 space-y-2">
                                <li>7 dagars garanti för ränder eller missade fläckar</li>
                                <li>14 dagars garanti för fågelspillning efter utfört arbete</li>
                                <li>Enkel bokning av garantibesök via bokningssystemet</li>
                                <li>Reseersättning kan tillkomma vid garantibesök</li>
                            </ul>
                        </div>

                        <div class="mt-8">
                            <a href="https://karlstad.putsamer.se" target="_blank" rel="noopener" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-primary hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500">
                                Boka fönsterputsning med garanti
                            </a>
                        </div>
                    </div>
                </div>
